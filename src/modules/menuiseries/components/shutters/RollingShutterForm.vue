<template>
    ...
    <div class="flex flex-col gap-3">
        <h2 class="text-ctext font-bold text-lg">Volets Roulants :</h2>
    ...
    <div v-if="selectedMaterial">
      ...
      <select v-model="modelValue.selectedColor" class="appearance-none p-2 border border-primary w-full rounded bg-secondary text-ctext focus:outline-none focus:ring-2 focus:ring-primary cursor-pointer">
